        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-6">
            <div className="bg-white rounded-xl border-white/10 overflow-hidden hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition">
              <a
                href="https://electronics-recommendation.vercel.app/"
                target="_blank"
              ...
              >
                <img
                  ...
                  alt="Electronics recommendation snapshot"
                />
                <h3 className="px-4 pt-4 font-bold">RECOMMENDATION SYSTEM</h3>
              </a>
              <div className="px-4 py-2">
                <p className="text-[#666] mb-4">
                  Electronics recommendation system aims at helping users choose
                  the best laptop in the market based on their requirements.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  {["React", "Django", "ML"].map((tech, key) => (
                    <span
                      key={key}
            ...
            <div className="bg-white rounded-xl border-white/10 overflow-hidden hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition">
              <a
                href="https://www.travelwithmangisafaris.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#2c3e50] hover:text-[#3498db] transition-colors"
              >
                <img
                  src={mangiSafari}
                  className="w-full h-auto"
                  alt="mangi safari website snapshot"
                />
                <h3 className="px-4 pt-4 font-bold">
                  TRAVEL WITH MANGI SAFARIS
                </h3>
              </a>
              <div className="px-4 py-2">
                <p className="text-[#666] mb-4">
                  A responsive website for a travel company, featuring
                  cross-browser compatibility and optimal user experience.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
            ...
            <div className="bg-white rounded-xl border-white/10 overflow-hidden hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition">
              ...
              >
                <img
                  src={cgaipSnap}
                  className="w-full h-auto"
                  alt="cgaip website snapshot"
                />
                <h3 className="px-4 pt-4 font-bold">CGAIP.org</h3>
              </a>
              <div className="px-4 py-2">
                <p className="text-[#666] mb-4">
                  A professional organizational website designed to improve
